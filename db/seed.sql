...
INSERT INTO user (username, email, password) VALUES ('gwashington', 'gwashington@usa.gov', 'firstprez');
INSERT INTO user (username, email, password) VALUES ('jadams', 'jadams@usa.gov', 'secondprez');
SELECT * FROM user;
